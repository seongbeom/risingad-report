...
@login_required
def portfolio():
    """매장 우선순위(전 매장 통합) — '오늘 어느 매장부터 볼까'를 한 화면에.
...
SHEET_TARGETS = [
    ...
    {"tab": "카카오 DA", "group": "효율탭 광고채널", "what": "카카오 디스플레이/비즈보드",
     "fields": "노출·클릭·광고비·전환·매출 (구매 클릭후7일)",
     "way": "api", "status": "live", "last_key": "kakao_last_run",
     "need": "—  (비즈니스 토큰 자동, 연동 매장만 / 토큰 60일마다 /kakao/start 재로그인)"},
    {"tab": "카카오 모객", "group": "효율탭 광고채널", "what": "카카오 친구늘리기",
     "fields": "노출·클릭·광고비",
     "way": "api", "status": "live", "last_key": "kakao_last_run",
     "need": "—  (비즈니스 토큰 자동)"},
    {"tab": "카카오 메세지", "group": "효율탭 광고채널", "what": "카카오 친구톡/알림톡",
     "fields": "광고비(계정단위 발송비)·매출",
     "way": "api", "status": "live", "last_key": "kakao_last_run",
     "need": "—  (비즈니스 토큰 자동, 발송일 기준)"},
